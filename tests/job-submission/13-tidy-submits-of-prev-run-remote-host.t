...
LOGD1="$(eval echo $(cylc get-global-config --print-run-dir))/${SUITE_NAME}/log/job/1/t1/01"
LOGD2="$(eval echo $(cylc get-global-config --print-run-dir))/${SUITE_NAME}/log/job/1/t1/02"
