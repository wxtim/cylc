...
section header defines a workflow at each point of the recurrence. For
...
Graph section headers can also be used with integer cycling see
\ref{IntegerCycling}.
...
The following examples show the various ways of writing graph headers in cylc.
\lstset{language=suiterc}
\begin{lstlisting}
[[[ R1 ]]]         # Run once at the initial cycle point
