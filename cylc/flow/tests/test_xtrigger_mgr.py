...
def test_housekeeping_with_xtrigger_satisfied(xtrigger_mgr):
    ...
    itask = TaskProxy(tdef, start_point, start_point, get_flow_num())
...
def test_check_xtriggers(xtrigger_mgr_procpool):
    ...
    start_point = ISO8601Point('2019')
    itask1 = TaskProxy(tdef1, start_point, start_point, get_flow_num())
    ...
    start_point = ISO8601Point('20000101T0000+05')
    # create task proxy
    itask2 = TaskProxy(tdef2, start_point, start_point, get_flow_num())
