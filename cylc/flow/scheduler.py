...
class Scheduler(object):
    ...
    def start(self):
        ...
        try:
            ...
            # Initial load to ensure dict is not empty and for
            # the localhost key to be loaded.
            ...
            credentials_provider = CredentialsProvider(
                self.curve_auth, self.client_pub_key_dir)
            self.curve_auth.configure_curve_callback(
                domain='*',
