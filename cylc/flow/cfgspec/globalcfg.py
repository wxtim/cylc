    ...
    def load(self):
        ...
        if conf_path_str:
            ...
            try:
                ...
                # This is required where globalconfig is being
                # retrieved on a remote platform where
                # CYLC_CONF_PATH has been set but points to
                # location on localhost - it's not good, because
                # it may cause silent failures.
                conf_path_str = None
